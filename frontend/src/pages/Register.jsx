            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <option value="customer" className="bg-white dark:bg-background-dark">Customer Portal</option>
                            <option value="admin" className="bg-white dark:bg-background-dark">Agency Administrator</option>
                        </select>
                    </div>
